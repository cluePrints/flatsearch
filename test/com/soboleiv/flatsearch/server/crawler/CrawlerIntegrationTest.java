...
public class CrawlerIntegrationTest {
	...
	public void test() throws Exception
	{
		...
		Crawler crawler = new Crawler(GreetingServiceImpl.DATA_REGEXP, GreetingServiceImpl.LINKS_REGEXP, GreetingServiceImpl.START_PAGE, GreetingServiceImpl.DATE_POSTED_REGEXP);
